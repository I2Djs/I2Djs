...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function renderer (root, factory) {
  ...
  RenderWebglRects.prototype.execute = function (stack) {
    ...
    let colorArray = []
    for (var i = 0, len = stack.length; i < len; i++) {
      let fill = stack[i].getStyle('fill') || {r: 0, g: 0, b: 0, a: 1.0}
  ...
  i2d.WebglLayer = function WebGLLayer (context, config) {
    ...
    root.execute = function executeExe () {
      ...
      // this.ctx.colorMask(true, true, true, false);
